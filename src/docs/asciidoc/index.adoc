...
해당 URL 로 요청하면 구글 로그인 페이지로 리디렉션 할 수 있다. 이후 구글 로그인 을 성공하면 지정된 URL 으로 엑세스 토큰과 함께ㄷ 리디렉션 으로 받을 수 있다.
...
Location: https://toyauction.kr/login?accessToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c
```
